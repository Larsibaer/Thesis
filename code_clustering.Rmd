...
```{r scaling}
n <- ncol(data_tfidf)
data_scaled <- cbind(data_tfidf[c(1,3,5,6,7)], data_tfidf[15:n])
```
...
# One-hot encoding
encoded_df_withCaseNumber <- one_hot_encode(data_scaled, c("created_by_group", "impact", "priority", "urgency"))
