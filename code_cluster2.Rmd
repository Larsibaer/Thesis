...
```{r scaling}
n <- ncol(data)
data_scaled <- cbind(data[1:8], scale(data[11:n]))
```
...
# One-hot encoding
encoded_df_withCaseNumber <- one_hot_encode(data_scaled, c("account", "created_by_group", "business_service", "impact", "priority", "urgency", "sla_has_breached"))
...
```
```{r}
# Take a look at the assignmet_group development
