...
```
```{r check}
data <- na.omit(select(data, case_type, account, created_by, business_service, assignment_group, auto_close, time_worked, reassignment_count, impact, priority, urgency, openedToClosed, created_by_group, sla_has_breached, number))
```
...
# One-hot encoding
encoded_df_withCaseNumber <- one_hot_encode(data, c("case_type", "account", "created_by", "business_service", "assignment_group", "auto_close", "impact", "priority", "urgency", "created_by_group", "sla_has_breached"))
